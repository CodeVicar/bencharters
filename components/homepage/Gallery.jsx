...
function Gallery() {
  ...
  const galleryTab = [
    ...
    {
      imageUrl: "/images/gallery/extension.jpeg",
      type: "Extention",
      // title: "Beautiful Work",
    },
    {
    ...
    },
    {
      ...
      type: "Brick and Stone Restoration",
      // title: "Beautiful Work",
    },
    {
      imageUrl: "/images/gallery/tile.jpeg",
      type: "Tiles",
      // title: "Beautiful Work",
    },
    {
      imageUrl: "/images/gallery/bathroom.jpeg",
      type: "Bathroom",
      // title: "Beautiful Work",
    },
  ];
  ...
  return (
    ...
    <div className="flex flex-col md:grid md:grid-cols-2 h-full gap-0 flex-wrap  md:mx-0">
